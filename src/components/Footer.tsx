...
export const Footer: React.FC = () => {
  return (
    <footer className="relative py-10 px-6 text-center border-t-2 border-accent-gold/30 bg-linear-to-br from-secondary-blue to-[#0C1117] overflow-hidden group">
      <div className="absolute top-0 -left-full w-[200%] h-full bg-gradient-to-r from-transparent via-accent-gold/10 to-transparent animate-shimmer pointer-events-none" />
